...
public class DtanglerArguments extends Arguments {
    ...
    /**
* Builds the Arguments from the string contains Dtangler command-line arguments. See
* <a href="http://web.sysart.fi/dtangler/documentation">Dtangler documentation</a> for more information
* about it`s command line parameters.
*
...
*
* @param pathList
* - list contains paths of input files/directories/jars that will be be parsed by Dtangler.
* @param scope
* the parsing scope. Supported values: "locations", "packages", "classes".
* @param cyclesAllowed
* - defines whether cyclic dependencies will fail the Dtangler cycles analyzing.
*
* @return Arguments that are appropriable for Dtangler java engine.
