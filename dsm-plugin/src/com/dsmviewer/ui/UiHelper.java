...
public final class UiHelper extends GUIHelper {
	...
	public static final Color COLOR_DSM_DIRECT_CYCLIC_DEPENDENCY_CELL_BG = getColor(255, 156, 156);
	public static final Color COLOR_DSM_TRANSITIVE_CYCLIC_DEPENDENCY_CELL_BG = getColor(255, 192, 203);
	public static final Color COLOR_DSM_TRANSITIVE_CYCLIC_DEPENDENCY_CELL_BG_LIGHT = getColor(255, 228, 225);
	 ...
	 * 
	 * @param imageId
	 *            String constant from ISharedImages i-face. Example: ISharedImages.IMG_OBJS_INFO_TSK
	 */
