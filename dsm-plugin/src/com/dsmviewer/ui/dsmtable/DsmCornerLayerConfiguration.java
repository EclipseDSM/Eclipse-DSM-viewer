 ...
 */
public class DsmCornerLayerConfiguration extends AbstractRegistryConfiguration {

    private static final int FONT_SIZE = 10;

    private static final int CELL_SPACING = 0;

    private final Color bgColor = GUIHelper.COLOR_DARK_GRAY;
    ...
    private ICellPainter cellPainter = new LineBorderDecorator(new TextPainter(false, true, CELL_SPACING, true));
